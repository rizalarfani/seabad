<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if($group->id==3){ ?>
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              <li class="active"><a href="<?php echo base_url('index.php/f_admin/laporan_pendapatan/pendapatan_per_alat');?>"><i class="fa fa-angle-double-right"></i> PENDAPATAN PER ALAT</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Grafik Pendapatan Per Alat</h3>
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <div id="chartPendapatanPerAlat" style="height: 250px;width:100%;"></div>
            </div>
            <!-- /.box-body -->
        </div>
      </div>
      ...
      <div class="col-md-12">
        ...
        <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Data Pendapatan Per Alat</h3>
            ...
            <div class="box-body table-responsive">
              <?php if($this->session->flashdata('info')): ?>
                ...
                <?php
                    ...
                    echo form_open('f_admin/laporan_pendapatan/pendapatan_per_alat/',$name);
                  ?>
                  ...
                  <select name="alat" id="alat" class="form-control">
                    ...
                    <option value="">Semua Alat</option>
                         <?php foreach($kendaraan as $knd){?>
                          <option value="<?php echo $knd->id;?>"><?php echo $knd->nm_kendaraan.' '.$knd->jns_kendaraan;?></option>
                         <?php } ?>
                  </select>
                </div>
                <script>
              ...
              ?>
               ...
               <a href="<?php echo base_url('index.php/f_admin/laporan_pendapatan/cetak_pendapatan_per_alat')?>" class="btn btn-warning"><i class="fa fa-print"></i> Print</a>        
            </div>
            <!-- /.box-body -->
        </div>
  ...
  <script type="text/javascript">
    ...
    window.onload = function () {
      var chart = new CanvasJS.Chart("chartPendapatanPerAlat", {
        title: {
          fontSize: 20,
          text: "LAPORAN PENDAPATAN PER ALAT"
        },
