        ...
        <div class="box box-warning">
            ...
            <div class="box-body table-responsive">
              <?php if($this->session->flashdata('info')): ?>
                ...
                <?php endif; ?>
              <a href="<?php echo base_url('index.php/f_admin/kelola_user/tambah_penyewa/');?>" class="btn btn-success btn-sm" style="margin-bottom:10px;">Tambah Penyewa</a>

              <?php if(!$data_list==null){?>
                <table id="penyewa" class="table table-condensed table table-hover table-bordered table-striped" cellspacing="0">
              <?php }else{?>
                ...
                <?php 
                  if(!$data_list==null){
                    ...
                    <tr>
                      ...
                      <td><?php echo $dt->nm_penyewa;?></td>
                      <td><?php echo $dt->alamat_ktp;?></td>
                      <td><?php echo $dt->nm_perusahaan;?></td>
                      <td><?php echo $dt->alamat_perusahaan;?></td>
                      <td><?php echo $dt->nm_jabatan;?></td>
                      <td><?php echo $dt->no_hp;?></td>
                      <td class="text-center">
                        <a href="<?php echo base_url('index.php/f_admin/kelola_user/edit_penyewa/'.$dt->nik);?>" class="btn btn-xs btn-info"><i class="fa fa-edit"></i> Edit</a>
                        <a href="#" onclick="functionDelete('<?php echo base_url('index.php/f_admin/kelola_user/hapus_penyewa/'.$dt->nik);?>')" class="btn btn-xs btn-danger"><i class="fa fa-trash"> Hapus</i></a>                 
                      </td>
                    </tr>
                  <?php } 
                 } else{ ?>
