<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('index.php/f_admin/kelola_alat');?>"><i class="fa fa-retweet"></i> Kelola pengaduan</a></li>
    ...
    <div class="col-sm-4">
        <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Foto jalan rusak di</h3>
            ...
            <div class="box-body">     
                    <div class="col-sm-12">
                        <img src="<?= base_url('assets/img/'.$foto->foto.'') ?>" class="img-responsive pad">
                    </div>    
            </div>
            <!-- /.box-body -->
        </div>
