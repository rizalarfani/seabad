...
<html>
<head>
	<title>Data Laporan Pendapatan Per Jenis Alat</title>
	<style type="text/css">
	table {
...
<?php 
  $bulan = array("Januari","Februari","Maret","April","Mei","Juni",
            ...
            ?>
	<h4 style="text-align: center;">LAPORAN PENDAPATAN PER JENIS ALAT</h4>
  <h4 style="text-align: center;">TAHUN <?php echo $tahun;?></h4>
    ...
    <thead>
      <tr>
        ...
        <th rowspan="2" style="background-color:#444;color:#fff;">JENIS KENDARAAN</th>
     ...
     <tbody>
      ...
      <tr>
        <td><?php echo $no++;?></td>
        <td><?php echo $dt->jns_kendaraan;?></td>
