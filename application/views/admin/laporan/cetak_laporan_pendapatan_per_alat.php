...
<html>
<head>
	<title>Data Laporan Pendapatan Per Alat</title>
	<style type="text/css">
	table {
...
<?php 
  $bulan = array("Januari","Februari","Maret","April","Mei","Juni",
            ...
            ?>
	<h4 style="text-align: center;">LAPORAN PENDAPATAN PER ALAT</h4>
    ...
    <thead>
      ...
      <tr>
        <?php foreach($bulan as $bln) { ?>
          <th style="background-color:#444;color:#fff;" width="60px"><?php echo $bln; ?></th>
        <?php } ?>
      </tr>
    </thead>
     <tbody>
