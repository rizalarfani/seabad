...
<div class="wrapper">
        ...
        <?php if($group->id==3){ ?>
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              <li class="active"><a href="<?php echo base_url('index.php/f_admin/laporan/kinerja_operator');?>"><i class="fa fa-angle-double-right"></i> KINERJA OPERATOR</a></li>
      ...
      <div class="col-md-12">
        ...
        <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Data Kinerja Operator</h3>
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <div id="chartKinerjaOperator" style="height: 250px;width:100%;"></div>
            </div>
            <!-- /.box-body -->
        </div>
      </div>
            ...
            <div class="box-body table-responsive">
              <?php if($this->session->flashdata('info')): ?>
                ...
                <?php
                    ...
                    echo form_open('f_admin/laporan/kinerja_operator/',$name);
                  ?>
                <div class="form-group">
                  <select name="operator" id="operator" class="form-control">
                    <option value="" disabled selected style="display:none;">-- Pilih Operator --</option>  
                    <option value="">Semua Operator</option>
                         <?php foreach($operator as $op){?>
                          <option value="<?php echo $op->operator;?>"><?php echo $op->operator;?></option>
                         <?php } ?>
                  </select>
                </div>
                <script>
               ...
               <?php if(!$data_list==null){?>
                <table id="laporanoperator" class="table table-condensed table table-hover table-bordered table-striped" cellspacing="0">
              <?php }else{?>
              ...
              ?>
                ...
                <tr>
                  ...
                  <th rowspan="2" style="vertical-align: middle;">Nama Operator</th>
                ...
                <?php 
                  if(!$data_list==null){
                    ...
                    <tr>
                      ...
                      <td><?php echo $value1->operator;?></td>
                      <?php $datapoin = $value1->bulan;
                        foreach ($datapoin as $key2 => $value2) { ?>
                          <td><?php echo $value2->total_perbulan; ?></td>
                        <?php } ?>
                    </tr>
                  <?php } 
                 } else{ ?>
               ...
               <a href="<?php echo base_url('index.php/f_admin/laporan/cetak_kinerja_operator')?>" class="btn btn-warning"><i class="fa fa-print"></i> Print</a>        
            </div>
            <!-- /.box-body -->
        </div>
  ...
  <script type="text/javascript">
    ...
    window.onload = function () {
      var chart = new CanvasJS.Chart("chartKinerjaOperator", {
        title: {
          fontSize: 20,
          text: "LAPORAN KINERJA OPERATOR"
        },
        ...
        <?php foreach ($data_list as $key1 => $value1) { ?>
          { 
            type: "line",
            showInLegend: true,
            legendText: "<?php echo $value1->operator; ?>",
            dataPoints:[
            <?php $datapoin = $value1->bulan; ?> 
            <?php foreach ($datapoin as $key2 => $value2) { ?>
              { 
                ...
                toolTipContent: "<?php echo $value1->operator; ?>: {y} Hari"
              },
            <?php } ?>
          ]},
        <?php } ?>
