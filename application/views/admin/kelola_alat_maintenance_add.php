            ...
            <div class="box-body">
              <div class="col-md-10">
                ...
                <?php
                  ...
                  echo form_open('f_admin/kelola_alat/tambah_maintenance/',$name);
                ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="bengkel" name="bengkel" placeholder="Bengkel" value="<?php echo set_value('bengkel');?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="jns_rusak" name="jns_rusak" placeholder="Jenis Rusak" value="<?php echo set_value('jns_rusak');?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="nilai" name="nilai" placeholder="Nilai" value="<?php echo set_value('nilai');?>">
