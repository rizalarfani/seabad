          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url('index.php/admin/setting');?>" class="btn btn-default btn-sm btn-flat"><i class="fa fa-gear"></i> Setting</a>
                </div>
            ...
            <div class="box-body">
              <div class="col-md-6 col-md-offset-3">
                ...
                <?php
                  ...
                  echo form_open('f_admin/kelola_user/changePassword/'.$data_list->id,$name);
                ?>
            ...
            <div class="box-body">
              <div class="col-md-6 col-md-offset-3">
                ...
                <?php
                  ...
                  echo form_open('f_admin/kelola_user/edit_user/'.$data_list->id,$name);
                ?>

                  <div class="form-group">
                    <label for="username" class="col-sm-4 control-label">Username</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="username" name="username" disabled="disabled" value="<?php echo $data_list->username;?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="email" name="email" disabled="disabled" value="<?php echo $data_list->email;?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="nik" name="nik" value="<?php echo $data_list->nik;?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="firstname" name="firstname" value="<?php echo $data_list->first_name;?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="lastname" name="lastname" value="<?php echo $data_list->last_name;?>">
                      <?php echo form_error('lastname');?>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-offset-4 col-sm-8">
                      <button type="submit" name="submit" value="submit" class="btn btn-default">Change</button>
                    </div>
                  </div>
                </form>
              </div>
