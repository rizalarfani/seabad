            ...
            <div class="box-body">
              <div class="col-md-10">
                ...
                <?php
                  ...
                  echo form_open('f_admin/kelola_sewa/edit_data/'.$sewa->id,$name);
            ?>

 <div class="form-group">
                    <label for="id" class="col-sm-4 control-label">id</label>
                    <div class="col-sm-8">
                      <input type="readonly" class="form-control" id="id" name="id" placeholder="id" value="<?php echo $sewa->id;?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <select id="nik" class="selectpicker form-control" data-live-search="true" name="nik">
                         <option value="<?php echo $sewa->id_penyewa;?>" selected style="display:none;"><?php echo $sewa->id_penyewa;?></option>
                         <?php foreach($penyewa as $penyewa){?>
                          <option value="<?php echo $penyewa->nik;?>"><?php echo $penyewa->nik;?></option>
                         <?php } ?>
                      </select>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <select id="nm_kendaraan" class="selectpicker form-control" data-live-search="true" name="nm_kendaraan">
                         <option value="<?php echo $sewa->id_kendaraan;?>" selected style="display:none;"><?php echo $sewa->nm_kendaraan.' '.$sewa->jns_kendaraan?></option>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="tgl_awal" name="tgl_awal" placeholder="yyyy/mm/dd" value="<?php echo $sewa->tgl_awal_sewa;?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="tgl_akhir" name="tgl_akhir" placeholder="yyyy/mm/dd" value="<?php echo $sewa->tgl_akhir_sewa;?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="pemakaian" name="pemakaian" placeholder="Rencana Pemakaian" value="<?php echo $sewa->renc_pemakaian;?>">
                      <?php echo form_error('pemakaian');?>
                    </div>
                  </div>

                  <div class="form-group">
                    <label for="jns_pekerjaan" class="col-sm-4 control-label">Jenis Pekerjaan</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="jns_pekerjaan" name="jns_pekerjaan" placeholder="Jenis Pekerjaan" value="<?php echo $sewa->jns_pekerjaan;?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="pendanaan" name="pendanaan" placeholder="Pendanaan" value="<?php echo $sewa->pendanaan;?>">
