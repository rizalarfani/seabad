        ...
        <div class="box box-warning">
            ...
            <div class="box-body table-responsive">
              <?php if($this->session->flashdata('info')): ?>
                ...
                <?php endif; ?>
              <a href="<?php echo base_url('index.php/f_admin/kelola_user/tambah_user/');?>" class="btn btn-success btn-sm" style="margin-bottom:10px;">Tambah User</a>

               <?php if(!$data_list==null){?>
                <table id="user" class="table table-condensed table table-hover table-bordered table-striped" cellspacing="0">
              <?php }else{?>
                  ...
                  if(!$data_list==null){
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="<?php echo base_url('index.php/f_admin/kelola_user/edit_user/'.$dt->id);?>" class="btn btn-xs btn-info"><i class="fa fa-edit"></i> Edit</a>
                        <a href="#" onclick="functionDelete('<?php echo base_url('index.php/f_admin/kelola_user/hapus_user/'.$dt->id);?>')" class="btn btn-xs btn-danger"><i class="fa fa-trash"> Hapus</i>                 
                      </td>
                    </tr>
                  <?php } 
                 } else{ ?>
