      ...
      <?php if($group->id==3){ ?>
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url('index.php/f_admin/laporan_pendapatan/pendapatan_semua_alat');?>"><i class="fa fa-angle-double-right"></i> PENDAPATAN SEMUA ALAT</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Grafik Pendapatan Semua Alat</h3>
      ...
      <div class="col-md-12">
        ...
        <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Data Pendapatan Semua Alat</h3>
            ...
            <div class="box-body table-responsive">
               <?php if(!$data_list==null){?>
                <table id="laporansemuaalat" class="table table-condensed table table-hover table-bordered table-striped" cellspacing="0">
              <?php }else{?>
