            ...
            <div class="box-body">
              <div class="col-md-10">
                ...
                <?php
                  ...
                  echo form_open('f_admin/kelola_user/tambah_penyewa/',$name);
                ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="alamat_ktp" name="alamat_ktp" placeholder="Alamat KTP" value="<?php echo set_value('alamat_ktp');?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="perusahaan" name="perusahaan" placeholder="Nama Perusahaan" value="<?php echo set_value('perusahaan');?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="alamat_pr" name="alamat_pr" placeholder="Alamat Perusahaan" value="<?php echo set_value('alamat_pr');?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="jabatan" name="jabatan" placeholder="Jabatan" value="<?php echo set_value('jabatan');?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="hp" name="hp" placeholder="No Hp" value="<?php echo set_value('hp');?>">
