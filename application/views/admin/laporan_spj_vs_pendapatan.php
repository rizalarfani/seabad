<div class="wrapper">
        ...
        <?php if($group->id==3){ ?>
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="<?php echo base_url('index.php/f_admin/laporan/spj_vs_pendapatan');?>"><i class="fa fa-angle-double-right"></i> SPJ VS PENDAPATAN</a></li>
            </ul>
          </li>
          <li class="treeview">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Laporan
        <small>Laporan SPJ Vs Pendapatan</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('index.php/f_admin/laporan');?>"><i class="fa fa-line-chart"></i> Laporan Pendapatan</a></li>
        <li class="active">Pendapatan SPJ Vs Pendapatan</li>
      </ol>
    </section>
    ...
    <section class="content container-fluid">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Grafik SPJ</h3>
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <div id="chartspj" style="height: 250px;width:100%;"></div>
            </div>
            <!-- /.box-body -->
        </div>
      </div>
      ...
      <div class="col-md-12">
        ...
        <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Data SPJ</h3>
            ...
            <div class="box-body table-responsive">
               <?php if(!$data_list2==null){?>
                <table id="laporanspj" class="table table-condensed table table-hover table-bordered table-striped" cellspacing="0">
              <?php }else{?>
              ...
              ?>
                ...
                <tr>
                  ...
                  <th rowspan="2" style="vertical-align: middle;">Nama Kendaraan</th>
                ...
                <?php 
                  if(!$data_list2==null){
                    foreach($data_list2 as $key1 => $value1){ ?>
                    <tr>
                      <td><?php echo $key1+1;?></td>
                      <td><?php echo $value1->nm_kendaraan.' '.$value1->jns_kendaraan;?></td>
               ...
               <a href="<?php echo base_url('index.php/f_admin/laporan/cetak_spj')?>" class="btn btn-warning"><i class="fa fa-print"></i> Print</a>        
            </div>
            <!-- /.box-body -->
        </div>
      ...
      <div class="col-md-12">
        ...
        <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <div id="chartpendapatansemuaalat" style="height: 250px;width:100%;"></div>
            </div>
            <!-- /.box-body -->
        </div>
      </div>
        ...
        <div class="box box-warning">
            ...
            <div class="box-body">
               <?php if(!$data_list==null){?>
                <table id="laporansemuaalat" class="table table-condensed table table-hover table-responsive table-bordered table-striped" cellspacing="0">
              <?php }else{?>
              ...
              ?>
               ...
               <a href="<?php echo base_url('index.php/f_admin/laporan_pendapatan/cetak_pendapatan_semua_alat')?>" class="btn btn-warning"><i class="fa fa-print"></i> Print</a>        
            </div>
            <!-- /.box-body -->
        </div>
  ...
  <script type="text/javascript">
    ...
    window.onload = function () {
      var chart = new CanvasJS.Chart("chartpendapatansemuaalat", {
        title: {
          fontSize: 20,
          text: "LAPORAN PENDAPATAN SEMUA ALAT"
        },
        ...
        <?php foreach ($data_list as $key1 => $value1) { ?>
          { 
            type: "line",
            showInLegend: true,
            legendText: "<?php echo $value1->nm_kendaraan; ?>",
            dataPoints:[
            <?php $datapoin = $value1->bulan; ?> 
            <?php foreach ($datapoin as $key2 => $value2) { ?>
              { 
                ...
                toolTipContent: "<?php echo $value1->nm_kendaraan; ?>: Rp {y}"
              },
            <?php } ?>
          ]},
        <?php } ?>
      ...
      var chart2 = new CanvasJS.Chart("chartspj", {
        title: {
          fontSize: 20,
          text: "LAPORAN SPJ"
        },
        ...
        data : [
        <?php foreach ($data_list2 as $key1 => $value1) { ?>
          { 
            type: "line",
            showInLegend: true,
            legendText: "<?php echo $value1->nm_kendaraan; ?>",
  ...
  $(document).ready(function(){
      $('#laporansemuaalat').DataTable({
        responsive: true
      });
  });

  $(document).ready(function(){
      $('#laporanspj').DataTable({
        responsive: true
      });
  });
