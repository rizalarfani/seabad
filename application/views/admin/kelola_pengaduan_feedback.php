<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Kelola Pengaduan
        <small>Kelola Pengaduan feedback Admin SEABAD</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('index.php/admin');?>"><i class="fa fa-home"></i> Kelola pengaduan Feedback</a></li>
            ...
            <table id="status" class="table table-condensed table table-hover table-responsive table-bordered table-striped" cellspacing="0">
                ...
                <?php foreach( $feedback as $data ):?>
                    <tr>
                        ...
                        <td><?= $data->kategori ?></td>
                        <td>
                            <a href="<?= base_url('pengaduan/add_feedback/') ?><?= $data->id_feedback ?>" class="btn btn-info">Feedback</a>
                            <a href="<?= base_url('pengaduan/hapus_feedback/') ?><?= $data->id_feedback ?>" class="btn btn-danger">Hapus</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
