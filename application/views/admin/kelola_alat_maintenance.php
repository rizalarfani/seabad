<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('index.php/f_admin/kelola_sewa');?>"><i class="fa fa-retweet"></i> Kelola Alat</a></li>
        ...
        <div class="box box-warning">
            ...
            <div class="box-body table-responsive">
              <?php if($this->session->flashdata('info')): ?>
                ...
                <?php endif; ?>
              <a href="<?php echo base_url('index.php/f_admin/kelola_alat/tambah_maintenance/');?>" class="btn btn-success btn-sm" style="margin-bottom:10px;">Tambah Data</a>

              <?php if(!$data_list==null){?>
                <table id="maintenance" class="table table-condensed table table-hover table-bordered table-striped" cellspacing="0">
              <?php }else{?>
              ...
              <?php }?>
                ...
                if(!$data_list==null){
                  ...
                  <tr>
                    ...
                    <td><?php echo $dt->tglawalm;?></td>
                    <td><?php echo $dt->tglakhirm;?></td>
                    <td><?php echo $dt->bengkel;?></td>
                    <td><?php echo $dt->alamat;?></td>
                    <td><?php echo $dt->jenisrusak;?></td>
                    <td><?php echo $dt->nilai;?></td>
                    <td class="text-center">
                      <a href="<?php echo base_url('index.php/f_admin/kelola_alat/edit_maintenance/'.$dt->id);?>" class="btn btn-xs btn-info"><i class="fa fa-edit"></i> Edit</a>
                      <a href="#" onclick="functionDelete('<?php echo base_url('index.php/f_admin/kelola_alat/hapus_maintenance/'.$dt->id);?>')" class="btn btn-xs btn-danger"><i class="fa fa-trash"> Hapus</i>
                    </td>                    
                  </tr>
                <?php }
                } else{?>
