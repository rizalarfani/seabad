<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>SI ALBERT</b></span>
    </a>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('index.php/admin');?>"><i class="fa fa-gear"></i> Setting</a></li>
            ...
            <div class="box-body">
              <div class="col-md-6 col-md-offset-3">
                ...
                <?php
                  ...
                  echo form_open('setting/changePassword/'.$user->id,$name);
                ?>
            ...
            <div class="box-body">
              <div class="col-md-6 col-md-offset-3">
                ...
                <?php
                  ...
                  echo form_open('setting/changeData/'.$user->id,$name);
                ?>
